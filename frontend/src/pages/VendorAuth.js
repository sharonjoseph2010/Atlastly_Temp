      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="bg-surface border-2 border-border rounded-lg p-8 shadow-hard">
          ...
          <p className="text-base md:text-lg text-primary mb-8">
            {isLogin ? 'Access your vendor dashboard' : 'List your event service for free'}
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              {!isLogin && (
                <p className="text-sm text-primary/70 mt-2">Minimum 6 characters</p>
              )}
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-secondary text-secondary-foreground hover:bg-secondary/80 h-12 px-8 rounded-full font-bold text-lg border-2 border-primary transition-transform active:scale-95 focus:ring-4 focus:ring-primary disabled:opacity-50 disabled:cursor-not-allowed"
